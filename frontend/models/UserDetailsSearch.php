...
/**
 * UserDetailsSearch represents the model behind the search form of `frontend\models\UserDetails`.
 */
class UserDetailsSearch extends UserDetails
{
    ...
    public function rules()
    {
        return [
            ...
            [['unique_id', 'first_name', 'last_name', 'mobile_no', 'street_no', 'street_address', 'apt', 'zip_code', 'profile_pic', 'current_position', 'speciality', 'looking_for', 'dob', 'work experience', 'job_looking_from', 'work_authorization_comment', 'license_suspended', 'professional_liability'], 'safe'],
        ];
    }
