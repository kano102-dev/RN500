                            ...
                            <div class="row">
                                <div class="col-md-8 col-sm-8">
                                    ...
                                    <div class="jobinfo">
                                        ...
                                        <div class="companyName"><a href="#" url="<?= Yii::$app->urlManagerFrontend->createUrl(['user-details/update', 'id' => Yii::$app->user->id]) ?>" class="btn btn-info editProfile" >Edit</a></div>
                                    </div>
