...
class LeadRecruiterJobSeekerMappingSearch extends LeadRecruiterJobSeekerMapping {
    ...
    public function rules() {
        return [
                [['branch_id', 'lead_id', 'job_seeker_id', 'rec_comment', 'rec_status ', 'updated_at', 'updated_by', 'rec_joining_date', 'employer_comment', 'employer_status', 'leadTitleWithRef', 'cityName', 'jobSeekerName', 'rec_joining_date_selected', 'recruiterComapnyWithBranch'], 'safe'],
                [['leadTitleWithRef', 'cityName', 'jobSeekerName', 'rec_joining_date_selected', 'recruiterComapnyWithBranch', 'statusText'], 'trim']
        ];
    }
    ...
    public function searchMyApplication($params) {
        $query = LeadRecruiterJobSeekerMapping::find()->alias('lrjs')
